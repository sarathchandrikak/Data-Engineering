...
def load_data_from_api(*args, **kwargs):
    ...
    df1 = pd.read_csv(url1, dtype=taxi_dtypes, parse_dates=parse_dates)
    df2 = pd.read_csv(url2, dtype=taxi_dtypes, parse_dates=parse_dates)
    df3 = pd.read_csv(url3, dtype=taxi_dtypes, parse_dates=parse_dates)
